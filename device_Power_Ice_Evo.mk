...
$(call inherit-product-if-exists, vendor/Highscreen/Power_Ice_Evo/Power_Ice_Evo-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Highscreen/Power_Ice_Evo/overlay
PRODUCT_PACKAGE_OVERLAYS += device/Highscreen/Power_Ice_Evo/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/Highscreen/Power_Ice_Evo
...
PRODUCT_NAME := full_Power_Ice_Evo
